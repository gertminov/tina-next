...
function Header() {
    ...
    return (
        <nav
            className="fixed w-full flex-none h-[10vh] px-4 bg-backgroundB z-10 border-b border-black flex justify-between items-center">
            <div className="flex">
                <Link href={"/"} className="font-serif text-5xl h-full w-32">
                    <svg fill="#000000" id="Ebene_1" data-name="Ebene 1" xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="hidden md:block">
                <ul className="flex gap-4">
                    <li><MenuLink href={"/"} name={"Home"}/></li>
                    <li><MenuLink href={"/about"} name={"About Me"}/></li>
                    <li><MenuLink href={"#work"} name={"Work"}/></li>
                    <li><MenuLink href={"#contact"} name={"Contact"}/></li>
                </ul>
            </div>
            <button className="md:hidden"  onClick={()=> {setShowMenu(!showMenu)}}>Menu</button>
            {showMenu && <div className="fixed inset-0 h-screen w-screen bg-backgroundB z-60 md:hidden flex flex-col items-end ">
                <div className="h-[20vh] w-[20vh] flex justify-center">
                    <button onClick={()=>{setShowMenu(!showMenu)}} className="mx-auto font-serif text-4xl">X</button>
                </div>
