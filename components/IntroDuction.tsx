...
function IntroDuction() {
    return (
        <div className="relative flex min-h-screen snap-start bg-background p-6 sm:p-12 md:min-h-[90vh] ">
            <MenuOffsetAnchor id={"about"} />
            <div className="flex w-full grow flex-row-reverse flex-wrap bg-white">
                <div className="relative h-48 basis-full md:h-full  md:basis-1/3">
                    <Image
                        src={"/TinaFoto.webp"}
                ...
                <div className="flex h-full basis-full place-content-center p-8 md:basis-2/3 md:p-12 ">
                    <div className="flex max-w-lg flex-col gap-8 md:justify-center">
                        ...
                        <p className="text-lg leading-8">
                            I am a business administration student with a focus
                            on marketing and media management. My creative head
                            is driven by thinking outside the box. I am a
                            marketing and trend enthusiast, looking for new
                            adventures in the field of media management, digital
